										...
										<tr>
											<td align="center">
												<s:if test="#request.page.hasPrePage">
													<a href="showAllNote.action?currentPage=1">首页</a>
													<a href="showAllNote.action?currentPage=${page.currentPage -1 }">上一页</a>
												</s:if>
												<s:else>
													首页
													上一页
												...
												<s:if test="#request.page.hasNextPage">
													<a href="showAllNote.action?currentPage=${page.currentPage + 1 }">下一页</a>
													<a href="showAllNote.action?currentPage=${page.totalPage }">尾页</a>			
												</s:if>
												<s:else>
													下一页
													尾页
				...
				<TR>
					...
					<TD COLSPAN="2" align="center" valign="top">
						<table width="1000" style="BORDER-RIGHT:#cccccc 1px solid; BORDER-TOP:#cccccc 1px solid; BORDER-LEFT:#cccccc 1px solid; BORDER-BOTTOM:#cccccc 1px solid; BACKGROUND-COLOR:#f5f5f5"
							...
							<tr height="30">
								<form action="addNote.action"> <input type=hidden name="load" value="e"></form>
